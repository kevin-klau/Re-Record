...
def singlePlayerRun(numHands=2, socketio=None):
    ...
    while cap.isOpened():
        ...
        if isMultiplayer:
            ...
            try:
                ...
                overlayNoteJPGP2 = cv2.imread(f"./backend/socketIOAPI/model/recorderFingering/{noteP2}.jpg")
            ...
            try:
                ...
                overlayNoteJPG = cv2.imread(f"./backend/socketIOAPI/model/recorderFingering/{note}.jpg")  
